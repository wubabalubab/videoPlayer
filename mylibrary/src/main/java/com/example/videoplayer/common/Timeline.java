...
import static com.example.videoplayer.common.AdPlaybackState.AD_STATE_UNAVAILABLE;
...
import com.example.videoplayer.common.MediaItem.LocalConfiguration;
  ...
  public static final class Window {
    ...
    private static final MediaItem PLACEHOLDER_MEDIA_ITEM =
        new MediaItem.Builder()
            .setMediaId("com.example.videoplayer.common.Timeline")
            .setUri(Uri.EMPTY)
            .build();
     ...
     * com.example.videoplayer.exoplayer.dash.manifest.DashManifest}, {@code
     * com.example.videoplayer.exoplayer.hls.HlsManifest} and {@code
     * com.example.videoplayer.exoplayer.smoothstreaming.SSManifest}.
     */
