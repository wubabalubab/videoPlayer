 ...
 */
package com.example.videoplayer.datasource;
...
import static com.example.videoplayer.datasource.HttpUtil.buildRangeRequestHeader;
...
public final class HttpEngineDataSource extends BaseDataSource implements HttpDataSource {
  ...
  private static boolean isCompressed(UrlResponseInfo info) {
    for (Entry<String, String> entry : info.getHeaders().getAsList()) {
