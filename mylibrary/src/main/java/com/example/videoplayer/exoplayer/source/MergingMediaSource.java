 ...
 *
 * <p>The values of {@link com.example.videoplayer.common.TrackGroup#id} and {@link
 * com.example.videoplayer.common.Format#id} are modified to start with {@code i:}, where {@code i} is the
 * 0-based index of the {@link MediaSource} passed to the constructor that created this {@link
 * com.example.videoplayer.common.TrackGroup} or {@link com.example.videoplayer.common.Format}.
 */
@UnstableApi
