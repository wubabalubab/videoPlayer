  ...
  private SegmentDownloaderFactory loadSegmentDownloaderFactory(
    ...
    switch (contentType) {
      case C.CONTENT_TYPE_DASH:
        factory =
            createSegmentDownloaderFactory(
                Class.forName("com.example.videoplayer.exoplayer.dash.offline.DashDownloader$Factory")
      ...
      case C.CONTENT_TYPE_HLS:
        factory =
            createSegmentDownloaderFactory(
                Class.forName("com.example.videoplayer.exoplayer.hls.offline.HlsDownloader$Factory")
                    .asSubclass(SegmentDownloaderFactory.class),
                cacheDataSourceFactory);
        break;
      case C.CONTENT_TYPE_SS:
        factory =
            createSegmentDownloaderFactory(
                Class.forName(
                        "com.example.videoplayer.exoplayer.smoothstreaming.offline.SsDownloader$Factory")
                    .asSubclass(SegmentDownloaderFactory.class),
                cacheDataSourceFactory);
        break;
      default:
