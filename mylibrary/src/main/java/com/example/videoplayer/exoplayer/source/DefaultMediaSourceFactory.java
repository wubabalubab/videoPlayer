...
import com.example.videoplayer.exoplayer.source.ads.AdsLoader;
import com.example.videoplayer.exoplayer.source.ads.AdsMediaSource;
    ...
    private Supplier<MediaSource.Factory> loadSupplier(@C.ContentType int contentType)
      ...
      switch (contentType) {
        case C.CONTENT_TYPE_DASH:
          clazz =
              Class.forName("com.example.videoplayer.exoplayer.dash.DashMediaSource$Factory")
                  .asSubclass(MediaSource.Factory.class);
          mediaSourceFactorySupplier = () -> newInstance(clazz, dataSourceFactory);
          break;
        case C.CONTENT_TYPE_SS:
          clazz =
              Class.forName("com.example.videoplayer.exoplayer.smoothstreaming.SsMediaSource$Factory")
                  .asSubclass(MediaSource.Factory.class);
          mediaSourceFactorySupplier = () -> newInstance(clazz, dataSourceFactory);
          break;
        case C.CONTENT_TYPE_HLS:
          clazz =
              Class.forName("com.example.videoplayer.exoplayer.hls.HlsMediaSource$Factory")
                  .asSubclass(MediaSource.Factory.class);
          mediaSourceFactorySupplier = () -> newInstance(clazz, dataSourceFactory);
          break;
        case C.CONTENT_TYPE_RTSP:
          clazz =
              Class.forName("com.example.videoplayer.exoplayer.rtsp.RtspMediaSource$Factory")
                  .asSubclass(MediaSource.Factory.class);
