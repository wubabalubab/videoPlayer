...
import com.example.videoplayer.common.util.CodecSpecificDataUtil;
...
import com.example.videoplayer.exoplayer.audio.AudioSink.InitializationException;
import com.example.videoplayer.exoplayer.audio.AudioSink.WriteException;
import com.example.videoplayer.exoplayer.mediacodec.LoudnessCodecController;
...
public class MediaCodecAudioRenderer extends MediaCodecRenderer implements MediaClock {
  ...
  private @AudioOffloadSupport int getAudioOffloadSupport(Format format) {
    com.example.videoplayer.exoplayer.audio.AudioOffloadSupport audioSinkOffloadSupport =
