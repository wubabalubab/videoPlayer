...
import static com.example.videoplayer.common.C.AUDIO_SESSION_ID_UNSET;
import static com.example.videoplayer.common.C.TRACK_TYPE_AUDIO;
import static com.example.videoplayer.common.C.TRACK_TYPE_CAMERA_MOTION;
import static com.example.videoplayer.common.C.TRACK_TYPE_IMAGE;
import static com.example.videoplayer.common.C.TRACK_TYPE_VIDEO;
import static com.example.videoplayer.common.util.Assertions.checkArgument;
...
import static com.example.videoplayer.exoplayer.Renderer.MSG_SET_AUDIO_ATTRIBUTES;
import static com.example.videoplayer.exoplayer.Renderer.MSG_SET_AUDIO_SESSION_ID;
import static com.example.videoplayer.exoplayer.Renderer.MSG_SET_AUX_EFFECT_INFO;
import static com.example.videoplayer.exoplayer.Renderer.MSG_SET_CAMERA_MOTION_LISTENER;
import static com.example.videoplayer.exoplayer.Renderer.MSG_SET_CHANGE_FRAME_RATE_STRATEGY;
import static com.example.videoplayer.exoplayer.Renderer.MSG_SET_IMAGE_OUTPUT;
import static com.example.videoplayer.exoplayer.Renderer.MSG_SET_PREFERRED_AUDIO_DEVICE;
import static com.example.videoplayer.exoplayer.Renderer.MSG_SET_PRIORITY;
import static com.example.videoplayer.exoplayer.Renderer.MSG_SET_SCALING_MODE;
import static com.example.videoplayer.exoplayer.Renderer.MSG_SET_SKIP_SILENCE_ENABLED;
import static com.example.videoplayer.exoplayer.Renderer.MSG_SET_VIDEO_EFFECTS;
import static com.example.videoplayer.exoplayer.Renderer.MSG_SET_VIDEO_OUTPUT_RESOLUTION;
...
import com.example.videoplayer.common.AuxEffectInfo;
import com.example.videoplayer.common.BasePlayer;
import com.example.videoplayer.common.C;
import com.example.videoplayer.common.C.TrackType;
import com.example.videoplayer.common.DeviceInfo;
import com.example.videoplayer.common.Effect;
import com.example.videoplayer.common.Format;
import com.example.videoplayer.common.IllegalSeekPositionException;
import com.example.videoplayer.common.MediaItem;
import com.example.videoplayer.common.MediaLibraryInfo;
import com.example.videoplayer.common.MediaMetadata;
import com.example.videoplayer.common.Metadata;
import com.example.videoplayer.common.PlaybackException;
import com.example.videoplayer.common.PlaybackParameters;
import com.example.videoplayer.common.Player;
import com.example.videoplayer.common.PriorityTaskManager;
import com.example.videoplayer.common.Timeline;
import com.example.videoplayer.common.TrackGroup;
import com.example.videoplayer.common.TrackSelectionParameters;
import com.example.videoplayer.common.Tracks;
import com.example.videoplayer.common.VideoFrameProcessor;
import com.example.videoplayer.common.VideoSize;
import com.example.videoplayer.common.text.Cue;
import com.example.videoplayer.common.text.CueGroup;
import com.example.videoplayer.common.util.BackgroundThreadStateHandler;
import com.example.videoplayer.common.util.Clock;
import com.example.videoplayer.common.util.ConditionVariable;
import com.example.videoplayer.common.util.HandlerWrapper;
import com.example.videoplayer.common.util.ListenerSet;
import com.example.videoplayer.common.util.Log;
import com.example.videoplayer.common.util.NullableType;
import com.example.videoplayer.common.util.Size;
import com.example.videoplayer.common.util.Util;
import com.example.videoplayer.exoplayer.PlayerMessage.Target;
import com.example.videoplayer.exoplayer.Renderer.MessageType;
import com.example.videoplayer.exoplayer.analytics.AnalyticsCollector;
import com.example.videoplayer.exoplayer.analytics.AnalyticsListener;
import com.example.videoplayer.exoplayer.analytics.DefaultAnalyticsCollector;
import com.example.videoplayer.exoplayer.analytics.MediaMetricsListener;
...
import com.example.videoplayer.exoplayer.audio.AudioSink;
import com.example.videoplayer.exoplayer.image.ImageOutput;
import com.example.videoplayer.exoplayer.metadata.MetadataOutput;
import com.example.videoplayer.exoplayer.source.MaskingMediaSource;
import com.example.videoplayer.exoplayer.source.MediaSource;
import com.example.videoplayer.exoplayer.source.MediaSource.MediaPeriodId;
import com.example.videoplayer.exoplayer.source.ShuffleOrder;
import com.example.videoplayer.exoplayer.source.TimelineWithUpdatedMediaItem;
import com.example.videoplayer.exoplayer.source.TrackGroupArray;
import com.example.videoplayer.exoplayer.text.TextOutput;
import com.example.videoplayer.exoplayer.trackselection.ExoTrackSelection;
import com.example.videoplayer.exoplayer.trackselection.TrackSelectionArray;
import com.example.videoplayer.exoplayer.trackselection.TrackSelector;
import com.example.videoplayer.exoplayer.trackselection.TrackSelectorResult;
import com.example.videoplayer.exoplayer.upstream.BandwidthMeter;
import com.example.videoplayer.exoplayer.video.VideoDecoderOutputBufferRenderer;
import com.example.videoplayer.exoplayer.video.VideoFrameMetadataListener;
import com.example.videoplayer.exoplayer.video.VideoRendererEventListener;
import com.example.videoplayer.exoplayer.video.spherical.CameraMotionListener;
import com.example.videoplayer.exoplayer.video.spherical.SphericalGLSurfaceView;
...
/* package */ final class ExoPlayerImpl extends BasePlayer implements ExoPlayer {
  ...
  public void setVideoEffects(List<Effect> videoEffects) {
    ...
    try {
      ...
      Class.forName("com.example.videoplayer.effect.SingleInputVideoGraph$Factory")
