 ...
 */
package com.example.videoplayer.common.text;

import static com.example.videoplayer.common.text.CustomSpanBundler.bundleCustomSpans;
...
public final class Cue {
   ...
   *     create it yourself.
   */
  @Deprecated public static final Cue EMPTY = new Builder().setText("").build();
