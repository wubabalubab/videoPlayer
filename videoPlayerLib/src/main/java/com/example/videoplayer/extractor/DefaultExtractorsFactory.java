 ...
 */
package com.example.videoplayer.extractor;

import static com.example.videoplayer.common.FileTypes.inferFileTypeFromResponseHeaders;
import static com.example.videoplayer.common.FileTypes.inferFileTypeFromUri;
import static com.example.videoplayer.extractor.mp4.Mp4Extractor.FLAG_READ_MOTION_PHOTO_METADATA;
import static com.example.videoplayer.extractor.mp4.Mp4Extractor.FLAG_READ_SEF_DATA;

import android.net.Uri;
import androidx.annotation.GuardedBy;
import androidx.annotation.Nullable;
import com.example.videoplayer.common.C;
import com.example.videoplayer.common.FileTypes;
...
import com.example.videoplayer.extractor.amr.AmrExtractor;
import com.example.videoplayer.extractor.avi.AviExtractor;
import com.example.videoplayer.extractor.avif.AvifExtractor;
import com.example.videoplayer.extractor.bmp.BmpExtractor;
import com.example.videoplayer.extractor.flac.FlacExtractor;
import com.example.videoplayer.extractor.flv.FlvExtractor;
import com.example.videoplayer.extractor.heif.HeifExtractor;
...
import com.example.videoplayer.extractor.mp3.Mp3Extractor;
import com.example.videoplayer.extractor.mp4.FragmentedMp4Extractor;
import com.example.videoplayer.extractor.mp4.Mp4Extractor;
import com.example.videoplayer.extractor.ogg.OggExtractor;
...
import com.example.videoplayer.extractor.ts.Ac3Extractor;
import com.example.videoplayer.extractor.ts.Ac4Extractor;
import com.example.videoplayer.extractor.ts.AdtsExtractor;
import com.example.videoplayer.extractor.ts.DefaultTsPayloadReaderFactory;
import com.example.videoplayer.extractor.ts.PsExtractor;
import com.example.videoplayer.extractor.ts.TsExtractor;
import com.example.videoplayer.extractor.ts.TsPayloadReader;
import com.example.videoplayer.extractor.wav.WavExtractor;
import com.example.videoplayer.extractor.webp.WebpExtractor;
 ...
 *   <li>FLAC
 *       <ul>
 *         <li>If available, the FLAC extension's {@code com.example.videoplayer.decoder.flac.FlacExtractor}
 *             is used.
 ...
 *   <li>MIDI, if available, the MIDI extension's {@code com.example.videoplayer.decoder.midi.MidiExtractor}
 *       is used.
 * </ul>
 */
@UnstableApi
public final class DefaultExtractorsFactory implements ExtractorsFactory {
   ...
   * by {@code com.example.videoplayer.decoder.flac.FlacExtractor} instances if the FLAC extension is being
   * used.
   *
  ...
  private static Constructor<? extends Extractor> getMidiExtractorConstructor()
    ...
    // LINT.IfChange
    return Class.forName("com.example.videoplayer.decoder.midi.MidiExtractor")
  ...
  private static Constructor<? extends Extractor> getFlacExtractorConstructor()
    ...
    boolean isFlacNativeLibraryAvailable =
        Boolean.TRUE.equals(
            Class.forName("com.example.videoplayer.decoder.flac.FlacLibrary")
                .getMethod("isAvailable")
                .invoke(/* obj= */ null));
    if (isFlacNativeLibraryAvailable) {
      return Class.forName("com.example.videoplayer.decoder.flac.FlacExtractor")
          .asSubclass(Extractor.class)
