  ...
  private static final class Api31 {
    ...
    public static void setForegroundServiceBehavior(
      ...
      if(Build.VERSION.SDK_INT >=Build.VERSION_CODES.S) {
        try {
          // 反射调用 NotificationCompat.Builder#setForegroundServiceBehavior(int)
          Method m = NotificationCompat.Builder.class
                  .getMethod("setForegroundServiceBehavior", int.class);
          m.invoke(notificationBuilder, 1); // FOREGROUND_SERVICE_IMMEDIATE = 1
