...
import com.example.videoplayer.exoplayer.audio.DefaultAudioSink;
import com.example.videoplayer.exoplayer.audio.MediaCodecAudioRenderer;
import com.example.videoplayer.exoplayer.image.BitmapFactoryImageDecoder;
import com.example.videoplayer.exoplayer.image.ImageDecoder;
import com.example.videoplayer.exoplayer.image.ImageRenderer;
import com.example.videoplayer.exoplayer.mediacodec.DefaultMediaCodecAdapterFactory;
import com.example.videoplayer.exoplayer.mediacodec.MediaCodecAdapter;
import com.example.videoplayer.exoplayer.mediacodec.MediaCodecSelector;
import com.example.videoplayer.exoplayer.metadata.MetadataOutput;
import com.example.videoplayer.exoplayer.metadata.MetadataRenderer;
import com.example.videoplayer.exoplayer.text.TextOutput;
import com.example.videoplayer.exoplayer.text.TextRenderer;
import com.example.videoplayer.exoplayer.trackselection.TrackSelector;
import com.example.videoplayer.exoplayer.video.MediaCodecVideoRenderer;
import com.example.videoplayer.exoplayer.video.VideoRendererEventListener;
import com.example.videoplayer.exoplayer.video.spherical.CameraMotionRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  /**
   * Enables {@link com.example.videoplayer.exoplayer.mediacodec.MediaCodecRenderer} instances to operate
  ...
  /**
   * Disables {@link com.example.videoplayer.exoplayer.mediacodec.MediaCodecRenderer} instances from
  ...
  protected void buildVideoRenderers(
    ...
    try {
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.example.videoplayer.decoder.vp9.LibvpxVideoRenderer");
      ...
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              Handler.class,
              com.example.videoplayer.exoplayer.video.VideoRendererEventListener.class,
              int.class);
    ...
    try {
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.example.videoplayer.decoder.av1.Libgav1VideoRenderer");
      // Full class names used for media3 constructor args so the LINT rule triggers if any of them
      // move.
      @SuppressWarnings("UnnecessarilyFullyQualified")
      Constructor<?> constructor =
    ...
    try {
      // LINT.IfChange
      Class<?> clazz =
          Class.forName("com.example.videoplayer.decoder.ffmpeg.ExperimentalFfmpegVideoRenderer");
      // Full class names used for media3 constructor args so the LINT rule triggers if any of them
      // move.
      @SuppressWarnings("UnnecessarilyFullyQualified")
      Constructor<?> constructor =
  ...
  protected void buildAudioRenderers(
    ...
    try {
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.example.videoplayer.decoder.midi.MidiRenderer");
      // Full class names used for media3 constructor args so the LINT rule triggers if any of them
      // move.
      @SuppressWarnings("UnnecessarilyFullyQualified")
      Constructor<?> constructor =
          clazz.getConstructor(
              Context.class,
              Handler.class,
              com.example.videoplayer.exoplayer.audio.AudioRendererEventListener.class,
              com.example.videoplayer.exoplayer.audio.AudioSink.class);
      // LINT.ThenChange(../../../../../../proguard-rules.txt)
      Renderer renderer =
    ...
    try {
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.example.videoplayer.decoder.opus.LibopusAudioRenderer");
      // Full class names used for media3 constructor args so the LINT rule triggers if any of them
      // move.
      @SuppressWarnings("UnnecessarilyFullyQualified")
      Constructor<?> constructor =
    ...
    try {
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.example.videoplayer.decoder.flac.LibflacAudioRenderer");
      // Full class names used for media3 constructor args so the LINT rule triggers if any of them
      // move.
      @SuppressWarnings("UnnecessarilyFullyQualified")
      Constructor<?> constructor =
    ...
    try {
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.example.videoplayer.decoder.ffmpeg.FfmpegAudioRenderer");
      // Full class names used for media3 constructor args so the LINT rule triggers if any of them
      // move.
      @SuppressWarnings("UnnecessarilyFullyQualified")
      Constructor<?> constructor =
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.example.videoplayer.decoder.iamf.LibiamfAudioRenderer");
      // Full class names used for media3 constructor args so the LINT rule triggers if any of them
      // move.
      @SuppressWarnings("UnnecessarilyFullyQualified")
      Constructor<?> constructor =
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz = Class.forName("com.example.videoplayer.decoder.mpegh.MpeghAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              Handler.class,
              com.example.videoplayer.exoplayer.audio.AudioRendererEventListener.class,
   ...
   * com.example.videoplayer.exoplayer.mediacodec.MediaCodecRenderer} instances.
   */
